...
const getItems = async (req, res) => {
    try {
        res.status(200).json({ status: 200, data: items, message: "Request successful" });
    } catch (err) {
...
const getItemById = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ status: 200, data: item, message: "Request successful" });
    } catch (err) {
...
const getItemsByCategory = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ status: 200, data: itemList, message: "Request successful" });
    } catch (err) {
        res.status(500).json({ status: 500, message: "Server error" });
    }
};
